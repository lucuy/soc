...
public class DiskSnmpUtil {

	public static String getDisk(String ip,String snmpCommunityName) {
		Snmp snmp = null;
			...
			//	System.out.println("list is null");
				...
				for(TableEvent event: list){
					...
					if(values!=null){
						...
						if ("1.3.6.1.2.1.25.2.1.4".equals(oid)){
							float[] temp = compute(values);
							disk+= "占用磁盘："+temp[0]+",比例："+temp[1]+"%";
							disk+="\n";
						}
					}
				}
	...
	String s=	getDisk("192.168.20.119","public");
