package com.compliance.model.cpManage;

public class TestCIAmodel {

	private int PK_CIA;//技术差距评估主键
	private int FK_CA;//测评表id
	private String CIA_Sort;
	...
	private String CIA_AssessResult;
	private String CIA_MainProbDes;
