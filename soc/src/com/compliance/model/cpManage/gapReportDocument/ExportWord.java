...
public class ExportWord {
	...
	public String getTitlett() {
		return titlett;
	}
	public void setTitlett(String titlett) {
		this.titlett = titlett;
	}
	private String subtitle;
	
	private String subsubtitle;
	private String pingtuimg;
	private String leidaimg;
	...
	private GapStatisticsUnit gapStatisticsUnit ;
	
	
	public GapStatisticsUnit getGapStatisticsUnit() {
		return gapStatisticsUnit;
	}
	public void setGapStatisticsUnit(GapStatisticsUnit gapStatisticsUnit) {
		this.gapStatisticsUnit = gapStatisticsUnit;
	}
	...
	public String getPingtuimg() {
		return pingtuimg;
	}
	public void setPingtuimg(String pingtuimg) {
		this.pingtuimg = pingtuimg;
	}
	public String getLeidaimg() {
		return leidaimg;
	}
	public void setLeidaimg(String leidaimg) {
		this.leidaimg = leidaimg;
	}
