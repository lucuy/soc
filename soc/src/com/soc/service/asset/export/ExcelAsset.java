...
public class ExcelAsset
{
    ...
    public void export(List<Map> list, String title,SettingCollectorService collectorManager)
    {
...
//        cell.setCellValue("资产id");
        ...
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 16));
        cell.setCellValue("资产IP");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 16));
        cell.setCellValue("资产网关");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 23));
        cell.setCellValue("资产IP段");
      ...
      /*  cell = row1.createCell(iColNumber);
       ...
       /* cell = row1.createCell(iColNumber);
        ...
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 23));
        cell.setCellValue("资产组架构");*/
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 16));
        cell.setCellValue("资产重要性");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 23));
//        cell.setCellValue("资产主机名");
        ...
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 16));
        cell.setCellValue("创建者登录名");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 16));
//        cell.setCellValue("资产节点id");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 16));
//        cell.setCellValue("资产节别名");
        ...
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 16));
        cell.setCellValue("采集类型");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 23));
        cell.setCellValue("团体名");
        ...
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 97));
        cell.setCellValue("监控目录");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 97));
        cell.setCellValue("监控文件");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 23));
//        cell.setCellValue("资产标识");
//        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 45));
...
//        cell.setCellValue("采集器id");
        ...
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 25));
        cell.setCellValue("采集器名称");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 23));
        cell.setCellValue("采集器mac");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 23));
        cell.setCellValue("采集器类型");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 16));
//        cell.setCellValue("设备类型id");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 23));
        cell.setCellValue("设备类型名称");
        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 23));
        cell.setCellValue("支持设备名称");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 16));
//        cell.setCellValue("支持设备id");
//        
        cell = row1.createCell(iColNumber);
        cell.setCellStyle(csHeader);
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 97));
        cell.setCellValue("特权命令");
...
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 97));
//        cell.setCellValue("资产关联规则");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 97));
//        cell.setCellValue("保密性价值");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 97));
//        cell.setCellValue("完整性价值");
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 97));
//        cell.setCellValue("可用性价值");      
        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 97));
//        cell.setCellValue("资产风险值");
...
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 23));
//        cell.setCellValue("资源系统名称");
//        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 23));
//        cell.setCellValue("资源系统版本");
//        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 23));
//        cell.setCellValue("资源系统版本号");
//        
//        cell = row1.createCell(iColNumber);
//        cell.setCellStyle(csHeader);
//        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//        sheet.setColumnWidth(iColNumber++, (256 * 23));
//        cell.setCellValue("资源系统品牌"); 
...
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_ID").toString());
//            String str = map.get("ASSET_SYSTEM_BRAND").toString();
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            cell.setCellValue(map.get("ASSET_IP").toString());
            
            //资产网关
            cell = row2.createCell(iColNumber++);
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            cell.setCellValue(map.get("ASSET_GATEWAY").toString());
            
            //资产ip段
            cell = row2.createCell(iColNumber++);
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            cell.setCellValue(map.get("ASSET_IP_SEGMENT").toString());
           ...
           /* //资产组架构
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            cell.setCellValue(map.get("ASSET_GROUP_FEATRUE").toString());*/
            
            //资产重要性
            cell = row2.createCell(iColNumber++);
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            int important = Integer.parseInt(map.get("ASSET_IMPORTANCE").toString());
            if(important==-1)
            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if (map.get("ASSET_HOST_NAME") != null)
//            {
//                cell.setCellValue(map.get("ASSET_HOST_NAME").toString());
//            }
//            else
//            {
//                cell.setCellValue("");
//            }
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_USER_LOGIN_NAME") != null)
            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if (map.get("ASSET_NODE_ID") != null)
//            {
//                cell.setCellValue(map.get("ASSET_NODE_ID").toString());
//            }
//            else
//            {
//                cell.setCellValue("");
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if (map.get("ASSET_ALIAS_NAME") != null)
//            {
//                cell.setCellValue(map.get("ASSET_ALIAS_NAME").toString());
//            }
//            else
//            {
//                cell.setCellValue("");
//            }
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_RESPONSIBILITY_USER_NAME") != null)
            {
                cell.setCellValue(map.get("ASSET_RESPONSIBILITY_USER_NAME").toString());
            }
            else
            {
                cell.setCellValue("");
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_ANSER_USER_NAME") != null)
            {
                cell.setCellValue(map.get("ASSET_ANSER_USER_NAME").toString());
            }
            else
            {
                cell.setCellValue("");
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            int temp1 =Integer.parseInt(map.get("NOTSURE").toString());
            if(temp1==-1)
            {
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_ORGANIZATION_NAME") != null)
            {
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_VERSION") != null)
            {
                cell.setCellValue(map.get("ASSET_VERSION").toString());
            }
            else
            {
                cell.setCellValue("");
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_MONITOR_DIRECTORIES") != null)
            {
                cell.setCellValue(map.get("ASSET_MONITOR_DIRECTORIES").toString());
            }
            else
            {
                cell.setCellValue("");
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_MONITOR_FILE") != null)
            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if (map.get("ASSER_WORK_IDENT") != null)
//            {
//                cell.setCellValue(map.get("ASSER_WORK_IDENT").toString());
//            }
//            else
//            {
//                cell.setCellValue("");
//            }
        ...
        /*    //所属资产组名称
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_GROUP_NAME") != null)
            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if (map.get("ASSET_COLLECTOR_ID") != null)
//            {
...
//                cell.setCellValue("");
//            }
            Collector collector=  collectorManager.queryById(Long.parseLong(map.get("ASSET_COLLECTOR_ID").toString()));
            //采集器名称
            cell = row2.createCell(iColNumber++);
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            try {
            	 cell.setCellValue(collector.getCollectorBasic());
			} catch (Exception e) {
				cell.setCellValue("");
			}
            ...
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            try {
           	 cell.setCellValue(collector.getCollectorMac());
			} catch (Exception e) {
				cell.setCellValue("");
			}
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_COLLECT_TYPE") != null)
            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if (map.get("ASSET_DEVICE_TYPE_ID") != null)
//            {
...
//            }
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_DEVICE_TYPE") != null)
            {
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_SUPPORT_DEVICE") != null)
            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if (map.get("ASSET_SUPPORT_DEVICE_ID") != null)
//            {
...
//            }
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            if (map.get("ASSET_PRIVILEGE_COMMAND") != null)
            {
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            int temp = Integer.parseInt(map.get("ASSET_STATUS").toString());
            if(temp==0)
            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            if(map.get("ASSET_DEVICES_REL_RULES") != null)
//            {
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_SECRET_VALUE").toString());
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_INTEGRITY_VALUE").toString());
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_USABILITY_VALUE").toString());            
...
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_SYSTEM_NAME").toString());
            
            //系统版本
//            cell = row2.createCell(iColNumber++);
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_SYSTEM_VERSION_NAME").toString());
            //系统版本号
//            cell = row2.createCell(iColNumber++);
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_SYSTEM_VERSIONNO_NAME").toString());
            //系统品牌
//            cell = row2.createCell(iColNumber++);
//            cell.setCellStyle(csBody);
//            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
//            cell.setCellValue(map.get("ASSET_SYSTEM_BRAND_NAME").toString());
//            
