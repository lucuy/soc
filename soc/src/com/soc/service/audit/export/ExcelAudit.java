package com.soc.service.audit.export;
...
public class ExcelAudit
{
    ...
    public void export(List<Map> list, String title)
    {
        ...
        cell.setCellType(HSSFCell.CELL_TYPE_STRING);
        sheet.setColumnWidth(iColNumber++, (256 * 6));
        ...
        for (int i = 0; i < list.size(); i++)
        {
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            cell.setCellValue(map.get("AUDIT_USER_lOGIN_NAME").toString());
            
            cell = row2.createCell(iColNumber++);
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            cell.setCellValue(map.get("AUDIT_OPERATION_IP").toString());
            ...
            cell.setCellStyle(csBody);
            cell.setCellType(HSSFCell.CELL_TYPE_STRING);
            cell.setCellValue(map.get("AUDIT_OPERARION_PROCEDURE").toString());
            //解析AUDIT_INFORMATION
