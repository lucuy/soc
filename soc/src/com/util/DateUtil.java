...
public class DateUtil {
	...
	public static String curTimeStr10(){
		Date date = new Date();
		return getDateParser("HH:mm:ss").format(date);
	}
	...
	public static String get24HourAgoTime(){
		
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		long currentTime = System.currentTimeMillis() ; 
		return formatter.format(new Date(currentTime - (1000*60*60*24)));
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(DateUtil.curDateTimeStr19());
		
	}
	public static String curDate21() {
		SimpleDateFormat hh = new SimpleDateFormat("yyyy年MM月dd日");
