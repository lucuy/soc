...
public class ZipUtil {
    ...
    public static boolean unZip(File file, String dest, boolean deleteFile) {
        try {
            if (!file.exists()) {
                //throw new RuntimeException("解压文件不存在!");
                return false;
    ...
    public static void main(String[] args) throws Exception {
        //压缩文件夹
//        boolean resultOfZip = ZipUtil.doZip(new File("F:/123/"), "F:/456/go.zip");
//        //System.out.println(resultOfZip);
//        ZipUtil.doZip("F:/apache-tomcat-6.0.16/webapps/compliance/template/te", "F:/apache-tomcat-6.0.16/webapps/compliance/template");
        
        //解压缩
//        File file = new File("F:/apache-tomcat-6.0.16/webapps/compliance/template/reportForm.zip");
//        boolean resultOfUnZip = ZipUtil.unZip(file, "F:/apache-tomcat-6.0.16/webapps/compliance/template/import/", false);
//
