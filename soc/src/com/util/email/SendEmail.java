...
public class SendEmail
{
    ...
    */     
    ...
    public static void main(String[] argv) {
        ...
        SendEmail inst_jidi=new SendEmail("smtp.qq.com");
        inst_jidi.setBody("五一放假通知、、、ok!");
        inst_jidi.setSubject("通知");
        inst_jidi.setTo("1273229943@qq.com");
        inst_jidi.setNeedSsl(true);
        /*inst_jidi.setSmtpPort("25");*/
        inst_jidi.setSSLSecurity("465");
        //inst_jidi.setNeedAuth(true);
        ////System.out.println("dddddddddd");
        inst_jidi.setNamePass("1273229943","");
        inst_jidi.setFrom("1273229943@qq.com");
        inst_jidi.sendout();
    }
}
