...
<%-- <script type="text/javascript" src="${ctx}/pushlet/ajax-pushlet-client.js"></script>--%>
	...
	function closewin(){
		window.opener.location.href="${ctx}/reportCustom.do?method=initPage";
		window.close();
	}  
		</script>
	</head>
...
<body>
		<form name="uploadForm" id="uploadForm" action="${ctx}/fileUpload/upload.action?callbackUrl=reportCustom.do?method=inportReportForm" method="post" enctype="multipart/form-data" >
		${mes }
