...
<script type='text/javascript'
	src="${ctx}/scripts/jquery.jqprint-0.3.js"></script>
...
<script language="javascript">
	...
	$(document)
			.ready(
					function() {
						...
						$
								.post(
										"${ctx}/events/queryUserByUserId.action",
										function(user) {
	...
	function buttonOK() {
		var str = "";
		$("#dialog-fieldSelect input[name='checkbox_th'][type='checkbox']")
				.each(function() {
		...
		$.post("${ctx}/events/updateFaild.action", {
			"strFaild" : str
		}, function() {
		});
	}
			...
			$("#mes")
					.html(
							"<div class='box'><div id='refresh' class='refresh'><b>"
									+ m
									+ "</b> 秒后更新数据 <input type=\"button\" value=\"编辑字段\" style=\"margin-left:5px;float:right;margin:4.5px 5px;\" class=\"btnstyle\" onclick=\"openFiledTable();\">"
									+ "  <input type=\"button\" value=\"打印\" style=\"margin-left:5px;float:right;margin:4.5px 5px;\" class=\"btnstyle\" onclick=\"preview();\"></div></div>");
	...
	function test1() {
		...
		//parent.parent.location.href='${ctx}/events/queryOriginalEvent.action?tableName='+tableName+'&eventsLogIdentification='+identifation;
		var url = "${ctx}/vulnerability/queryEventLibraryList.action?eventLibraryId="
				+ queryEventsId + "&detail=info";
	...
	function preview() {
		try {
			...
			$.each($("td[id=\"event_th_level\"]"), function(n, val) {

				var pro = $(val).attr("name");
				$(val).html(
						"<span style='margin-left:30px;'>" + pro + "</span>");
...
<body onload="reFresh();">
	...
	<div id="conn" class="conn">
		<input type="hidden" id="otableName" /> <input type="hidden"
			id="oidentification"> <input type="hidden"
			id="eventsCustomd1" />
		<s:form action="queryRecentEvents" namespace="/events" method="post"
			theme="simple" id="events" name="eventsForm">
									...
									<table width="100%" cellspacing="1" cellpadding="0" border="0"
										...
										<thead>
											<tr height="28" class="biaoti">
												...
												<th width="12%" id="event_th_type" class="biaoti">事件类型</th>
												<th width="10%" id="event_th_driverName" class="biaoti">设备名称</th>
												<th width="15%" id="event_th_receiveTime" class="biaoti">接收时间</th>
												<th width="10%" id="event_th_ip" class="biaoti">源IP</th>
												<th width="10%" id="event_th_targetIp" class="biaoti">目标IP</th>
												<th width="8%" id="event_th_sorcePort" class="biaoti">源端口</th>
												<th width="*" id="event_th_targerPort" class="biaoti">目标端口</th>
											</tr>
										</thead>
										<tbody>
											...
											<s:iterator var="e" value="events">
												...
												<tr class="back" id="eventsTr_${eventsLogId}_${eventsType}"
													...
													<td id="event_th_level" name="${priority }"><input
														type="hidden" value="${priority }" />
													...
													<td id="event_th_driverName" valign="middle" align="center">${customs5}</td>

													<td id="event_th_receiveTime" valign="middle"
														align="center">${receptTimes}</td>

													<td id="event_th_ip" valign="middle" align="center"><s:property
															value="#e.getsAdd()" /></td>

													<td id="event_th_targetIp" valign="middle" align="center">
														<s:property value="#e.gettAdd()" /></td>
													<td id="event_th_sorcePort" valign="middle" align="center">
														<s:property value="#e.getsPort()" /></td>
													<td id="event_th_targerPort" valign="middle" align="center">
														<s:property value="#e.getdPort()" /></td>
										...
										<tr style="background-color:#FFFFFF; ">
											<td colspan="11" width="100%"><div id="over"><jsp:include
														page="../commons/page.jsp"></jsp:include></div>
											</td>
										</tr>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_level" value="event_th_level"
								onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_level');">事件级别</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_name" value="event_th_name"
								onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_name');">事件名称</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_type" value="event_th_type"
								onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_type');">事件类型</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_driverName"
								value="event_th_driverName" onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_driverName');">设备名称</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_receiveTime"
								value="event_th_receiveTime" onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_receiveTime');">接收时间</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_ip" value="event_th_ip"
								onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_ip');">源IP</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_targetIp"
								value="event_th_targetIp" onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_targetIp');">目标IP</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_sorcePort"
								value="event_th_sorcePort" onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_sorcePort');">源端口</a>
							</td>
						</tr>
						<tr>
							<td valign="middle" class="biaocm" align="center"><input
								type="checkbox" class="check-box-assetGroup" checked="checked"
								name="checkbox_th" id="id_event_th_targerPort"
								value="event_th_targerPort" onclick="event.cancelBubble=true;">
							</td>
							<td valign="middle" class="td_t"><a
								href="javascript:void(0);"
								onclick="clickFaild('id_event_th_targerPort');">目标端口</a>
							</td>
						</tr>
					</table></td>
			</tr>
