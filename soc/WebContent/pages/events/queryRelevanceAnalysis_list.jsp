...
function exportExcel() {
	...
	if(ids == ""){
		if(confirm("你是要导出全部的系统日志...")){
			location.href = "${ctx}/events/exportEventExcel.action?checkids="+ ids+"&conditions="+$("#conditions").val()+"&biaozhi=2";
		}
	}else{
...
<body>
	...
	<s:form action="queryCustonRule.action" namespace="/events" method="post" theme="simple" id="events" name="eventsForm">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr >
                   ...
                   <input type="hidden" value="执行" style="margin-left:5px"
