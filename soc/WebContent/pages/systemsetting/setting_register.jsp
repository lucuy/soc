...
<script>
	...
	$(function() {
		$("#add").click(function() {
			...
			//$("#testTbl1").append('<tr id="kdel11_' + i + '"><td class="td_detail_separator"></td></tr><tr id="kdel12_' + i + '"><td width="13.5%"><input type="text" id="collectorIp" name="collectorIp" class="validate[custom[settingIp]] text-input"/><td rowspan="3" style="padding-left:6px"><input  type="button" value="&nbsp;删&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;除&nbsp;" onclick="del('+i+')" class="btnstyle" /></td></tr><tr id="kdel13_' + i + '"><td class="td_detail_separator"></td></tr><tr id="kdel14_' + i + '"><td>  <input type="test" name="collectorGroup" id="collectorGroup"/></td></tr>');
			i++;
		});
		$("#del").click(function() {
...
<body style="margin-top: 2px">
	<s:form id="setting-localCollector" name="setting-localCollector"
		action="saveLogger" namespace="/settingLogger" method="post"
		theme="simple">
		<s:token></s:token>
				...
				<td width="100%" valign="top">
					<div class="framDiv">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="0">
							<tr>
								<td class="r2titler"><b>注册采集器 </b><font id="message1"></font>
								</td>
							</tr>
							...
							<tr>
								<td>
									<table width="98%" border="0" cellspacing="0" cellpadding="0"
										...
										<tr>
											<td width="40%"><span class="spanred">*</span>采集器名称</td>
											<td colSpan="2"><input name="collectorBasic"
												id="collectorBasic" type="text"
										...
										<tr>
											<td><span class="spanred">*</span>MAC（唯一标识）</td>
											<td colSpan="2"><input name="collectorMac" onblur="selectMac()"
												id="collectorMac" type="text"
												class="validate[required,custom[validateLength],custom[validateSpase]] text-input  " /><span id="check_loginname_msg"></span>&nbsp;&nbsp;<font color="red"><span>例如：00-00-00-00-00-00</span></font>
											</td>
										</tr>
										<!-- 空行 custom[required]-->
										<tr>
										...
										<tr>
											<td width="30%"><h4>snmp walk</h4></td>
										</tr>
										<!-- 水平线 -->
										<tr>
											<td colSpan="3"><div class="xuxian"></div>
										...
										<tr>
											...
											<td colSpan="2"><input type="text" id="collectorTime"
												name="collectorTime"  maxlength="255"
										...
										<tr>
											<td align="left" style="vertical-align:10%"><span
												class="spanred"></span>OID</td>
											<td align="left"><select name="ips" id="ips"
												style="width:205px;" size="3" multiple="multiple">
													<c:forEach items="${addressPolicy.addressList}" var="l">
														<option value="${l.addressStartIp}">${l.addressEndIp}</option>
													</c:forEach>
											</select></td>
										</tr>
										<tr>
										...
										<!-- <tr>
											...
											<td  width="13.5%">
											<input type="text"
												id="collectorIp" name="collectorIp"
										...
										空行
										<tr>
											<td colSpan="2" class="td_detail_separator"></td>
										</tr>
										<tr>
											<td>团体名 </td>
											<td>
											<input type="text" id="collectorGroup"
												name="collectorGroup" class="validate[required,custom[validateLength],custom[spechars]] text-input " /></td>
                                        </tr> -->
										<!-- 空行 -->
										<tr>
										...
										<tr>
											<td colSpan="2"><h4>snmp trap</h4></td>
										</tr>
										<!-- 水平线 -->
										<tr>
											<td colSpan="3"><div class="xuxian"></div>
										...
										<tr>
											<td><span class="spanred">*</span>端口</td>
										...
										<tr>
											<td>网络环境</td>
											<td colSpan="2">
											<select id="collectNetwork" name="collectNetwork" style="width:20%;">
