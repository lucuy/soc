...
<body style="margin:5px;">
	...
	<s:form action="updateFilteringRule.action" namespace="/filteringRules"
		...
		<div class="framDiv" style="width:100%;">
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
				<!-- 用户信息 -->
				<tr>
					<td class='r2titler' colspan='3'><b>自定义过滤规则</b></td>
				</tr>
				<tr>
					<td>
						...
						<table width="99%" border="0" align="center" cellspacing="0"
							...
							<tr>
								<td class="td_detail_separator"><input type="text"
									...
									value="${filteringRule.filteringRuleId }" /></td>
							</tr>
							<!-- 公告标题 -->
							<tr>
							...
							<tr>
								...
								<td align="left" class="padding"><input
									class="validate[required,custom[onlyLetterNumber]] text-input"
									name="filteringRule.filteringRuleCreater" readonly="readonly"
									value="${filteringRule.filteringRuleCreater }" type="text"
									size="40" id="assetName" maxlength="255" style="width: 270px" />
								</td>
							...
							<tr>
								...
								<td align="left" class="padding"><input
									...
									value='<s:date
										name="filteringRule.filteringRuleCreateDate" format="yyyy-MM-dd HH:mm:ss" />'
									type="text"
							...
							<tr>
								...
								<td align="left" class="padding"><input
									class="validate[required,custom[onlyLetterNumber]] text-input"
									name="filteringRule.filteringRuleMender" readonly="readonly" readonly="readonly"
							...
							<tr>
								...
								<td align="left" class="padding"><input
									name="filteringRule.filteringRuleMenderDate" id="assetGateWays"
									value='<s:date
							...
							<tr>
								...
								<td align="left" class="padding"><input type="radio"
									name="filteringRule.filteringRuleType" value="0" title="启用"
									<c:if test="${filteringRule.filteringRuleType==0}">checked="checked"</c:if> /><span
									style="font-size:12px;">启用</span> <input type="radio"
									name="filteringRule.filteringRuleType" value="1" title="停用"
									<c:if test="${filteringRule.filteringRuleType==1}">checked="checked"</c:if> /><span
		...
		<div class="framDiv" style="width:100%;">
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
				<!-- 用户信息 -->
				<tr>
					<td class='r2titler' colspan='3'><b>自定义过滤条件</b>&nbsp;<span style = "font-size:12px;font-weight:normal;"><a href="${ctx}/riskfile/filter.doc" class="jianju" style="color:#F00">书写说明</a></span></td>
				</tr>
...
<tr>
				...
				<tr>
					...
					<td ><span class="spanred" style = "font-size:12px">*&nbsp;</span><span style = "font-size:12px">自定义过滤条件:&nbsp;&nbsp;</span><textarea
							name="filteringRule.filteringRuleCondition" id="assetMemo" cols="37"
							rows="8" style="width:500px;resize:none;">${filteringRule.filteringRuleCondition }</textarea>
					</td>
				</tr>
