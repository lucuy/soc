...
<html>
      	...
      	<script>
        	jQuery(document).ready(function(){               
          	...
          	function subdata(){
           		...
           		var arry=serialFile.val().split("\\");
        	    if(arry[arry.length-1]!="compliance.licence"){
        	        alert("请上传compliance.licence文件");
        		    return;
        	    }
				$("form").submit();
           }
	...
	<body style="margin-top: 2px">
	  <center>
	  <s:form id="serial" action="initRegister" namespace="/serial" method="post" theme="simple" name="serial" enctype="multipart/form-data">
		<!--  左侧table-->
		...
		<tr>
			<td colspan="3" align="center">
				...
				<input type="button" class="btnyh" id="btnSave" value="退出系统"  onclick="javascript:window.close();"/>
			</td>
		</tr>
		</table>
		</s:form>
