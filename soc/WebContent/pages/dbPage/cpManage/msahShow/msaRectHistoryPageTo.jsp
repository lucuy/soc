...
<script type="text/javascript">
   jQuery(document).ready(function()
	{
	 parent.leftFrame.location.href='${ctx}/pages/dbPage/cpManage/msahShow/msaRectHistoryMenus.jsp';
	 parent.mainFrame.location.href='${ctx}/pages/dbPage/cpManage/msahShow/msaRectHistory.jsp';
