...
<script type="text/javascript">
   jQuery(document).ready(function()
	{
	 parent.leftFrame.location.href='${ctx}/pages/dbPage/cpManage/demand/demandCollect/demandCollectMenus.jsp';
	 parent.mainFrame.location.href='${ctx}/pages/dbPage/cpManage/demand/demandCollect/demandCollectList.jsp';
