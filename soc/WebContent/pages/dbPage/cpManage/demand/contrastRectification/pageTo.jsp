...
<script type='text/javascript' src="${ctx}/scripts/jquery-1.7.2.min.js"></script>
 ...
 <script type="text/javascript">
   jQuery(document).ready(function()
	{
	 parent.leftFrame.location.href='${ctx}/pages/dbPage/cpManage/demand/contrastRectification/ContrastMenus.jsp';
	 parent.mainFrame.location.href='${ctx}/pages/dbPage/cpManage/demand/contrastRectification/ContrastList.jsp';
	});
	</script>
 </head>
  <body>
