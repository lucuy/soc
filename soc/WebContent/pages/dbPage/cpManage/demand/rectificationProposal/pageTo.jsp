...
<script type="text/javascript">
   jQuery(document).ready(function()
	{
	 parent.leftFrame.location.href='${ctx}/pages/dbPage/cpManage/demand/rectificationProposal/ProposalMenu.jsp';
	 parent.mainFrame.location.href='${ctx}/pages/dbPage/cpManage/demand/rectificationProposal/proposalList.jsp';
	});
	</script>
  </head>
