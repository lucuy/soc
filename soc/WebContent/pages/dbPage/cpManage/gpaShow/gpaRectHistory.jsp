...
<script type="text/javascript" src="${ctx}/scripts/jquery-ui.custom.min.js"></script>
	...
	$(document).ready(function() {
	       var gpaDate=document.getElementById("gpaDate");
	       var type=document.getElementById("type");
		    jsonForAjax("${ctx}/gpaRect/queryGpaReHistory.action?gpaDate="+ gpaDate.value+"&type="+type.value+ "&t=" + new Date());
	    }
	);
			...
			$.each(result.processLog, function(i,item) {
			 	...
			 	if(item.sonContent!= null){
			 		...
			 		htmlStr += "<tr>";
			 			...
			 			htmlStr += "</td>";
			 			htmlStr += "<td  style=\"cursor:pointer;text-align:center\">";
			 			  htmlStr += item.gpaRectAdvise;
			 			htmlStr += "</td>";
			 			htmlStr += "<td  style=\"cursor:pointer;text-align:center\">";
			 			  htmlStr += item.gpaRectDate;
			 			htmlStr += "</td>";
			 		htmlStr += "</tr>";
			 	}
  ...
  <body style="padding-left: 2px;">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
			<tr>
				<td>
				 <div class="caozuobox">
				 <form action="${ctx}/gpaRect/gapexportexcel.action" method="post" width="0px" height="0px">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr height="30" >
							<td><input type="submit" class="btnstyle" style="margin-left: 2px"value="导出列表"></td>
								 <td width="100" valign="middle">
					                 <input type="hidden"  name="gpaDate" id="gpaDate"  value="<s:property value="#parameters.gpaDate"/>"  width="0px" height="0px">
							...
							<div id="dataList">
								...
								<thead>
									<tr >				 
										...
										<th width="30%"   class="biaoti" onclick="sortAble('table-userManage', 3)"  style="cursor:pointer" >整改建议</th>
