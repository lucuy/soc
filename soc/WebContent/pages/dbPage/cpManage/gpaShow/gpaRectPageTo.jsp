...
<script type="text/javascript">
   jQuery(document).ready(function()
	{
	 parent.leftFrame.location.href='${ctx}/pages/dbPage/cpManage/gpaShow/gpaRectMenus.jsp';
	 //parent.mainFrame.location.href='${ctx}/pages/cpManage/gpaShow/gpaRect.jsp';
	 parent.mainFrame.location.href='${ctx}/pages/dbPage/cpManage/gpaShow/gpaRect.jsp';	
	});
	</script>
  </head>
  <body>
