...
<script type="text/javascript">
   jQuery(document).ready(function()
	{
	 parent.leftFrame.location.href='${ctx}/pages/dbPage/cpManage/gpaShow/gpaRectHistoryMenus.jsp';
	 parent.mainFrame.location.href='${ctx}/pages/dbPage/cpManage/gpaShow/gpaRectHistory.jsp';
