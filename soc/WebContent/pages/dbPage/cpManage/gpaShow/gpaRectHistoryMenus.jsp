...
$(document).ready(function() {
	$.getJSON("${ctx}/gpaRect/queryHistoryTree.action?dataTime="+new Date(), function(result) {
		var contentStr = "";
		$.each(result.processLog, function(i, item) {
			contentStr+="<li><a href=\"javascript:void(0);\">"+item.gpaDate+"</a>";
			contentStr+="<ul>";
			contentStr+=" <li><a href=\"${ctx}/pages/dbPage/cpManage/gpaShow/gpaRectHistory.jsp?gpaDate="+item.gpaDate+"&type=1\" target=\"mainFrame\"  title=\"部分符合项\">部分符合项</a></li>";
			contentStr+=" <li><a href=\"${ctx}/pages/dbPage/cpManage/gpaShow/gpaRectHistory.jsp?gpaDate="+item.gpaDate+"&type=2\" target=\"mainFrame\" title=\"不符合项\">不符合项</a></li>";
			contentStr+=" <li><a href=\"${ctx}/pages/dbPage/cpManage/gpaShow/gpaRectHistory.jsp?gpaDate="+item.gpaDate+"&type=3\" target=\"mainFrame\" title=\"不适用\">不适用</a></li>";
			contentStr+="</ul>";
			contentStr+="</li>";
		});
