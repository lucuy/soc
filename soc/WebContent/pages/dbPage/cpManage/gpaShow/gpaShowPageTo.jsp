...
<script type="text/javascript">
   jQuery(document).ready(function()
	{
	 parent.leftFrame.location.href='${ctx}/pages/dbPage/cpManage/gpaShow/gpaShowMenus.jsp';
	 //parent.mainFrame.location.href='${ctx}/pages/cpManage/gpaShow/gpaShow.jsp';
	 parent.mainFrame.location.href='${ctx}/gpaShow/gpaShowNoFitFirst.action';
	});
	</script>
  </head>
