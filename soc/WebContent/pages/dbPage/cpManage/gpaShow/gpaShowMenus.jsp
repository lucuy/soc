...
$(document).ready(function() {
	$.getJSON("${ctx}/gpaShow/queryTree.action?dataTime="+new Date(), function(result) {
		...
		$.each(result.processLog, function(i, item) {
			...
			contentStr+="<ul>";
			contentStr+=" <li><a href=\"${ctx}/gpaShow/gpaShowNoFit.action?gpaDate="+item.gpaDate+"&type=1\" target=\"mainFrame\"  title=\"部分符合项\">部分符合项</a></li>";
			contentStr+=" <li><a href=\"${ctx}/gpaShow/gpaShowNoFit.action?gpaDate="+item.gpaDate+"&type=2\" target=\"mainFrame\" title=\"不符合项\">不符合项</a></li>";
			contentStr+=" <li><a href=\"${ctx}/gpaShow/gpaShowNoFit.action?gpaDate="+item.gpaDate+"&type=3\" target=\"mainFrame\" title=\"不符合项\">不适用</a></li>";
			contentStr+="</ul>";
			contentStr+="</li>";
