...
<SCRIPT src="${ctx}/scripts/jquery-1.7.2.min.js" type=text/javascript></SCRIPT>
	...
	<body onload="first()">
		<form id="scoreFrm" name="scoreFrm" method="post"
			action="${ctx}/rank/rankAction_rankFour.action" style="width:99%">
						...
						<tr>
							...
							<td width="70%" colspan="3">
								<table border="0" width="100%" >
									...
									<tr>
									    <td style="text-align:right;width:50%"  >系统级别：</td>
										<td style="text-align:left;width:50%" >
						...
						<tr>
							...
							<td colspan="3">
								<textarea id="rankInfoSysIntr" name="rankInfoSysIntr" 
									...
									class="txtRequired 100"  lang="2"></textarea>
							</td>
						</tr>
					</table>
					<br>
				...
				<table width="100%" >
					<tr >
						<td style="text-align: right">
							<input type="button" value="下一步"  class="btnyh"
								onclick="goahead()"/>
						</td>
