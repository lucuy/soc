...
<script src="${ctx}/scripts/jquery.ui.core.js" type="text/javascript"></script>
...
function back(){
	...
	location.href="${ctx}/pages/basic/employee.jsp";
}
...
function updataUser(){
	...
	location.href ="${ctx}/employee/updataEmployee.action?userID="+userID
			+"&userName="+encodeURI(encodeURI(userName,"utf-8"))
				...
				<div class="sbox">
					<div class="cont">
						...
						<table width="100%" class="framDiv">
							...
							<tr height="28">
								<td width="10%" scope="col" align="right">登陆用户名：<font color="#ff0000">*</font></td>
								...
								<td width="40%" scope="col">
									<div>
										<input type="text" onblur="yanzheng1(this)"  name="trueName" id="trueName" maxlength="50" value="${employee.trueName}" style="width:200px" />
									</div>
								</td>
							</tr>
							<tr>
								<td scope="col" align="right">登陆密码：<font color="#ff0000">*</font></td>
								<td>
									<div>
										<input type="password" name="password" id="password" maxlength="50" style="width:200px" />
									</div>
								</td>
								<td scope="col" align="right">确认密码：<font color="#ff0000">*</font></td>
								<td>
									<div>
										<input type="password" name="passwordAgain" id="passwordAgain" maxlength="50" style="width:200px" />
									</div>
								</td>
							</tr>
							<tr>
								...
								<td colspan="3">
									<div>
										<input type="text" onblur="isCardNo(this)" id="IDCardNum" maxlength="50" name="IDCardNum" value="${employee.IDCardNum}" style="width:200px" />
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3">						
								<c:if test="${employee.userAuthority=='0'}"><input name="ids" type="checkbox" checked="checked" value="0" />  系统管理员&nbsp;
								 <input name="ids" type="checkbox" value="1" />  安全管理员&nbsp;</c:if>
								 <c:if test="${employee.userAuthority=='1'}"><input name="ids" type="checkbox" value="0" />  系统管理员&nbsp;
								 <input name="ids" type="checkbox" checked="checked" value="1" />  安全管理员&nbsp; </c:if>	
								 <c:if test="${employee.userAuthority=='2'}"><input name="ids" type="checkbox" checked="checked" value="0" />  系统管理员&nbsp; 
								 <input name="ids" type="checkbox" checked="checked" value="1" />  安全管理员&nbsp; </c:if>
								</td>
							</tr>
							<tr>
					...
					<table width="100%" >
						<tr >
							...
							<input type="button" value="取消" onclick="back()" class="btnstyle" />
							 ...
							 <input type="button" value="保存" id="subBtn" onclick="updataUser()" class="btnstyle" />
							</td>
