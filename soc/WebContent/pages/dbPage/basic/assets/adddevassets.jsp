...
var msgSysNames="";
var msgSysName = "";
var msgSysNamesTemp="";var sysNameTemp = ";";
var resNameTemp = ";";
var action = "";
...
function softSearch(num) {
	 ...
	 if($.trim($("#softUseId").val()).length >20){
	  		alert("业务应用软件名称不能大于20个字符");
	  		btnSub.disabled="";
	  		$("#softUseId").focus();
	  		return false;
	 }
...
function back()
{
	location.href="${ctx}/pages/dbPage/basic/assets/devassets.jsp";
}
...
function save(){
  ...
  function ChooseDevName()
   ...
   function ChooseImpDegree()
    ...
    return this.length + (cArr == null ? 0 : cArr.length);       
     ...
     function textLimitCheck(thisArea, maxLength){    
       ...
       if(len <= maxLength)
        {
         if(ma.test($.trim($("#devDescription").val())) || $.trim($("#devDescription").val())=="")
          {
            return true;
           }else
            {
   ...
   if(len <= maxLength)
   {
     if(main.test($.trim($("#devRemarks").val())) || $.trim($("#devRemarks").val())=="")
     {
         return true;
      }else
      {
  ...
  <s:form action="add" method="post" namespace="/devAssets" theme="simple" id="devAssets">
  <input type="hidden" name="id" value="${devAssets.id}">
	  	...
	  	<tr>
				<td width="100%" valign="top">
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0"   >
                                 <tr>
									<td colspan="4" class='r2titler' style="font-size: 12px">安全设备编辑</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style="text-align:left">
										<input type="text" style="width:250px" id="sysName"  maxlength="50" name="sysName" value="${devAssets.sysName}" readonly="readonly" onclick="$('#goToSearch').val('');employeeDlg()"/>
									</td>
								</tr>
								<tr>
										<td class="td_detail_separator"></td>
									...
									<td style="text-align:left">
										<input type="text" id="devName"  name="devName"  maxlength="20" value="${devAssets.devName}" style="width:250px"  onblur="ChooseDevName(this.value)"/>
									</td>
								</tr>
								<tr>
										<td class="td_detail_separator"></td>
								...
								<tr>
									...
									<td style="text-align:left">
										<input type="text" style="width:250px" id="impDegree" name="impDegree" value="${devAssets.impDegree}"  maxlength="50" onblur="ChooseImpDegree(this.value)"/>
									</td>
								</tr>
								<tr>
									<td class="td_detail_separator"></td>
								...
								<tr>
									...
									<td colspan="3" style="text-align: left;">
										<textarea rows="3" style="width:40%" id="devDescription" maxlength="50" name="devDescription" >${devAssets.devDescription}</textarea>
									</td>
								</tr>
								<tr>
									<td class="td_detail_separator"></td>
								...
								<tr>
									...
									<td colspan="3" style="text-align: left;">
										<textarea rows="3" style="width:40%" id="devRemarks" maxlength="50" name="devRemarks" >${devAssets.devRemarks}</textarea>
										&nbsp;
									</td>
								</tr>
								<tr>
