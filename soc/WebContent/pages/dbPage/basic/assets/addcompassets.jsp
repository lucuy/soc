...
function back()
{
	//location.href="${ctx}/compAssets/query.action";
	location.href="${ctx}/pages/dbPage/basic/assets/compassets.jsp";
}
...
function save(){
 ...
 //验证所属系统名称，只能输入字母、汉字、字母汉字组合，禁止输入特殊字符 否则则清空
      function ChooseDevName()
      {
          var reg=/^([\u0391-\uFFE5A-Za-z\d])+$/;
          if(reg.test($.trim($("#devName").val())) || $.trim($("#devName").val())=="")
          {
            return true;
          }else
          {
    ...
    return this.length + (cArr == null ? 0 : cArr.length);       
     ...
     function textLimitCheck(thisArea, maxLength){    
       ...
       if(len <= maxLength)
        {
         if(ma.test($.trim($("#compDescription").val())) || $.trim($("#compDescription").val())=="")
          {
            return true;
           }else
            {
   ...
   //验证备注当字符长度超过500时自动删除大于500的字符
   function RemarksCheck(thisArea, maxLength){    
    var len = thisArea.value.getBytes(); 
    var main=/^([\u0391-\uFFE5A-Za-z0-9])+$/;
   if(len <= maxLength)
   {
     if(main.test($.trim($("#compRemarks").val())) || $.trim($("#compRemarks").val())=="")
     {
         return true;
      }else
      {
  ...
  <input type="hidden" name="sysNameTempOO" id="sysNameTempOO" />
   <input type="hidden" name="sysNameTempSoft" id="sysNameTempSoft" />
  <input type="hidden" name="sysNameTempOOSoft" id="sysNameTempOOSoft" />
  
  <s:form action="add" method="post" namespace="/compAssets" theme="simple" id="compAssets">
  <input type="hidden" name="id" value="${compAssets.id}">
	  	...
	  	<tr>
				<td width="100%" valign="top">
							...
							<table width="100%" border="0" cellspacing="1" cellpadding="0"   >
                                 <tr>
									<td colspan="4" class='r2titler' style="font-size: 12px">主机存储设备编辑</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style="text-align:left;font-size: 12px">主机存储设备</td>
								</tr>
								<tr>
									<td class="td_detail_separator"></td>
								</tr>
								<tr>
									...
									<td style="text-align:left">
										<input type="text" style="width:250px"  id="sysName" width="99%" name="sysName"  maxlength="500" value="${compAssets.sysName}" readonly="readonly" onclick="$('#goToSearch').val('');employeeDlg()"/>
									</td>
								</tr>
								<tr>
									<td class="td_detail_separator"></td>
								...
								<tr>
									<td class="tdleft">设备名称：<font color="#ff0000">*</font></td>
									<td style="text-align:left">
										<input type="text" id="devName"  name="devName"  maxlength="50" value="${compAssets.devName}" style="width:250px"  onblur="ChooseDevName(this.value)"/>
									</td>
								</tr>
								<tr>
									<td class="td_detail_separator"></td>
								...
								<tr>
									...
									<td style="text-align:left">
										<input type="text" style="width:250px" id="resName" maxlength="50" name="resName" value="${compAssets.resName}" readonly="readonly" onclick="$('#softUseId').val('');sysUseDlg()"/>
									</td>
								</tr>
								<tr>
									<td class="td_detail_separator"></td>
								...
								<tr>
									...
									<textarea rows="3" style="width:40%" id="compDescription" name="compDescription">${compAssets.devDescription}</textarea>
									</td>
								</tr>
								<tr>
										<td class="td_detail_separator"></td>
								...
								<tr>
									...
									<td colspan="3" style="text-align: left;">
										<textarea rows="3" style="width:40%" id="compRemarks" name="compRemarks">${compAssets.devRemarks}</textarea>
										&nbsp;</td>
								</tr>
								<tr>
									<td class="td_detail_separator"></td>
...
<!-- ui-dialog-employee -->
		<div id="dialog-employee" title="所属信息系统">
		...
		<!-- ui-dialog-softInfo -->
		<div id="dialog-softUse" title="业务应用软件" style="font-size: 12px">
			<table width="97%" border="0" cellspacing="0" cellpadding="0">
			<tr>
