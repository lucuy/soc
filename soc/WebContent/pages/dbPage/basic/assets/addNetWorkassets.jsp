...
function back()
{
	location.href="${ctx}/pages/dbPage/basic/assets/networkassets.jsp";
}
...
<body>
  ...
  <input type="hidden" name="sysNameTempOO" id="sysNameTempOO" />
	<s:form action="add" method="post" namespace="/netAssets"
		theme="simple" id="netAssets">
		<input type="hidden" name="id" value="${netAssets.id}">
				...
				<td width="100%" valign="top">
					...
					<div class="framDiv">
						<table width="100%" border="0" cellspacing="1" cellpadding="0">
							<tr>
								<td colspan="4" class='r2titler' style="font-size: 12px">网络互连设备编辑</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="text-align:left;">网络互连设备
								</td>
							</tr>
							<tr>
								<td class="td_detail_separator"></td>
							...
							<tr>
								...
								<td style="text-align:left">
									<input type="text" style="width:250px" id="sysName" width="99%" name="sysName" maxlength="500" value="${netAssets.sysName}" readonly="readonly" onclick="$('#goToSearch').val('');employeeDlg()" />
								</td>
							</tr>
							<tr>
								<td class="td_detail_separator"></td>
							...
							<tr>
								...
								<td style="text-align:left">
									<input type="text" id="devName"  name="devName" maxlength="20" value="${netAssets.devName}" style="width:250px" onblur="ChooseDevName(this.value)" />
								</td>
							</tr>
							<tr>
								<td class="td_detail_separator"></td>
							...
							<tr>
								...
								<td style="text-align:left">
									<input type="text" style="width:250px" id="impDegree" maxlength="50" name="impDegree" value="${netAssets.impDegree}" onblur="ChooseImpDegree(this.value)" />
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan="3" style="text-align: left;">
									<textarea rows="3" style="width:40%" id="devDescriotion" maxlength="50" name="devDescriotion">${netAssets.devDescriotion}</textarea>
								</td>
							</tr>
							<tr>
								<td class="td_detail_separator"></td>
							...
							<tr>
								...
								<td colspan="3" style="text-align: left;font-size: 12px"><textarea
										rows="3" style="width:40%" id="netRemarks" maxlength="50" name="netRemarks">${netAssets.netRemarks}</textarea>
									&nbsp;</td>
							</tr>
							<tr>
								<td class="td_detail_separator"></td>
				...
				<td>
					...
					<div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr height="30">
								<td valign="middle" align="right"><input type="button"
									value="取消" class="btnyh" onclick="back()" /> <input
									type="button" value="保存" class="btnyh" id="btnSub"
									onclick="save()" /></td>
							</tr>
						</table>
	...
	<div id="dialog-employee" title="所属信息系统" style="font-size: 12px;">
		<table width="97%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="font-size: 12px;">快速搜索：<input
					name="dlg-keyword-sysName" id="goToSearch" onblur="yanzheng1(this)"
