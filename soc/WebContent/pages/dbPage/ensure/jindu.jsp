...
<script type="text/javascript" src="${ctx}/scripts/report/highcharts-more.js"></script>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
		...
		location.href="${ctx}/gapAnalysisSchedule/gapSchedule.action?pkca="+val;
	 });
...
<s:select list="#request.listss"  listValue="caName" listKey="pkca" label="系统" id="mySelect"  onchange="changeAction();">
</s:select></div>
