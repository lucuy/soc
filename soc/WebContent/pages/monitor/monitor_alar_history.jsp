...
<script language="javascript" >
	...
	function queryAll(){
        ...
        var ip = $("#ip").val();
    	var falg=$("#falg").val();
        location.href='${ctx}/monitorGroup/queryMonitorAPM.action?ip='+ip+'&falg='+falg+'&startTime='+beginTime+'&endTime='+endTime;
							...
							<div id="dataList">
								<table width="100%" border="0" cellspacing="1" cellpadding="0"
									...
									<tbody>
										...
										<s:iterator value="monitorAlarmHistories" status="stat">
											<tr>
										...
										name="monitorAlarmTime" format="yyyy-MM-dd HH:mm:ss" /></td>
											</tr>
