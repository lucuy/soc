...
<script type="text/javascript">
	...
	function testLink(){
		...
		.ajax({
			type : "post",
			url : "${ctx}/monitorDBT/testLink.action?dbIp="+ip+"&port="+port+"&username="+username+"&pwd="+pwd+"&dbType="+type,
			async : false,
			dataType : "text",
			success : function(result) {
				if (result == 'true') {
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td width="50%" valign="top"><input type="hidden"
					name="mondbt.taskId" id="taskId" value="${mondbt.taskId}" /> <input
											...
											<table width="100%">
												...
												<tr>
													...
													<td width="70%" colspan="2"><input type="text"
														...
														<c:if test="${mondbt.dbPort ==null}" > value="3306" </c:if>
