...
<script type="text/javascript">
	...
	function testLink(){
		...
		var db2iupdt;
			...
			db2iupdt = $("#db2iupdt").val();
			if(db2iupdt==null||db2iupdt==''){
				alert("实例名不能为空！");
				return;
			}
		...
		.ajax({
			type : "post",
			url : "${ctx}/monitorDBT/testLink.action?type="+type+"&dbIp="+ip+"&port="+port+"&username="+username+"&pwd="+pwd+"&db2iupdt="+db2iupdt+"&dbType="+type,
			async : false,
			dataType : "text",
			success : function(result) {
				if (result == 'true') {
											...
											<table width="100%">
												<tr>
													...
													<td width="70%" colspan="2"><input type="text"
														...
														style="width: 270px"
														<c:if test="${mondbt.taskName !=null}"> readonly="readonly"</c:if> value="${mondbt.taskName}" />
											...
											<table width="100%">
												...
												<tr>
													...
													<td width="70%" colspan="2"><input type="text"
														...
														<c:if test="${mondbt.dbPort ==null}" > value="1521" </c:if> 
												...
												<tr>
													<td height="20" align="right" width="18%"><span
														style="color:red;">*</span>实例(服务)名：</td>
													<td width="70%" colspan="2"><input type="text"
														name="mondbt.db2iupdt" id="db2iupdt"
														class="validate[required,maxSize[50]] text-input "
														style="width: 270px" value="${mondbt.db2iupdt}" /></td>
												</tr>
											...
											<table width="100%">
												...
												<tr>
													...
													<td width="70%" class="msg" colspan="2"><textarea
															rows="6" name="mondbt.taskDESC" id="taskDESC" cols="35" value="${mondbt.taskDESC}"></textarea>
													</td>
												</tr>
											</table>
										</fieldset>
