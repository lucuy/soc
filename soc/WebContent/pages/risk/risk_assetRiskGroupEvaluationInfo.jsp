							...
							<div id="dataList">
								<table width="100%" border="0" cellspacing="1" cellpadding="0"
									...
									<tr height="28" class="biaoti">
										...
										<td width="30%" class="biaoti">资产组名称</td>
										<td width="20%" class="biaoti">总资产平均值</td>
										<td width="10%" class="biaoti">可用性平均值</td>
										<td width="10%" class="biaoti">完整性平均值</td>
										<td width="10%" class="biaoti">保密性平均值</td>
									</tr>
									<s:iterator value="assetGroupList" status="stat">
										...
										<tr>
											...
											<td valign="middle"><a href="${ctx}/assetRiskGroup/queryEvaluationByName.action?assetGroupId=${assetGroupId}">${assetGroupName}</a></td>
