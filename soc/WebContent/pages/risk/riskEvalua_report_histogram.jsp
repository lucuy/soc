...
<!--
	...
	-->
<link href="/soc/styles/library.css" rel="stylesheet" type="text/css">
	...
	<table width="70%">
		...
		<tr>
			<td>
				...
				<div id="container" width="680px"></div>
			</td>
		</tr>
						...
						<table width="70%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td align="center" width="30%"><img
									...
									value="导出为html" onclick="Export('html');" /></td>
								<td align="center" width="30%"><img
									src="/soc/images/u21.png"> <input type="button"
									class="btnyh" width="50%" style="font-size: 12px;" id="btnSave"
									value="导出为DOC" onclick="Export('doc');" /></td>
								<td align="center" width="30%"><img
									src="/soc/images/u23.png"> <input type="button"
									class="btnyh" width="50%" style="font-size: 12px;" id="btnSave"
									value="导出为PDF" onclick="Export('pdf');" /></td>
							</tr>
							<tr>
								<td class="td_detail_separator"></td>
							</tr>
