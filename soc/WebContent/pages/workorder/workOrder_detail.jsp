...
<%-- <script type="text/javascript" src="${ctx}/pushlet/ajax-pushlet-client.js"></script>--%>
	...
	<script type="text/javascript">
		...
		function sub(){
			var obj = document.getElementsByName("workOrder.status");
			var value = 0;
  ...
  <body>
  	<s:form action="updateWordOrder.action" namespace="/workOrder" method="post" id="workfrm" name="workfrm">
    		<!-- 主table -->
    		<s:token></s:token>
    						...
    						<table width="100%" border="0" cellspacing="1" cellpadding="0">
								...
								<tr>
									<td height="20"  align="right"  width="18%">
										<span style="color: red">*</span>工单名称：
									</td>
								...
								<tr>
									...
									<td width="70%" class="msg" colspan="2" >
										...
										<input type="radio" name="workOrder.status" value="1" <c:if test="${workOrder.status ==1  }">checked="checked"</c:if> <c:if test="${workOrder.status !=0  }">disabled="disabled"</c:if>    />已处理 &nbsp;
								...
								<tr>
									<td height="20"  align="right"  width="18%">
										<span style="color: red">*</span>工单指派者：
									</td>
									<td width="70%"  colspan="2" >
										<input  type="text" class="validate[required,custom[validateLength],custom[spechars]] text-input "   
								...
								<tr>
									<td height="20"  align="right"  width="18%">
										<span style="color: red">*</span>工单操作者：
									</td>
									<td width="70%"  colspan="2" >
										<input  type="text"    
    		...
    		<table align="right">
				<tr align="right">
					...
					<c:if test="${workOrder.status ==0 }">
						<input type="button" 	id="btnSave"  value="保  存" class="btnyh" onclick="sub()" width="80"  ></c:if>
