...
var rege =/^([^`~!@#$%^&*()=|{}':;, \\\[\].<>\/?~！@#￥……&*（）—|{}【】‘；：”“'。\"，、？])*$/;
		...
		function query(){
			...
			location.href = "${ctx}/workOrder/query.action?keyword="+encodeURI(encodeURI(keyword,"utf-8"))+"&falg=3";
		}
			//点击高级弹出框的开始
		...
		function closeReanson(){
			var closeReason=$("#addCloseReason").val();
			...
			$.ajax({
				type : "POST",
				url : "${ctx}/workOrder/closeWorkOrder.action?workOrderId="+workOrderId+"&closeReason="+encodeURI(encodeURI(closeReason,"utf-8")),
				data : "",
				dataType : 'text',
				success : function(msg) {
					$('#dialog-close').dialog('close');
					if(msg=='0'){
			var html="已关闭<a href=\"javascript:void(0);\" onclick=\"openCloseReanson("+workOrderId+")\">&nbsp;&nbsp;&nbsp;关闭原因</a>";
			$("#message_"+workOrderId).html(html);	
					}
					if(msg=='1'){
						alert("此工单已处理，无法关闭！");
					}
...
<body style="margin-top:2px;">
	...
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		...
		<div class="box">
			<div class="right">
				...
				<input type="button" value="添加" class="btnstyle"
					...
					onclick="location.href='${ctx}/workOrder/toAddWorkOrder.action'" /> 
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="0"
						...
						<c:forEach items="${listWork}" var="Ls">
							<tr>
								...
								<td valign="middle" >
								<span id="message_${Ls.workOrderId}">
									<c:if test="${Ls.status==0}">未处理&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="openClose(${Ls.workOrderId})">关闭工单</a></c:if>
		...
		<input type="hidden" name="falg" value="3">
		</td></tr>
		</table>
	</s:form>
	...
	<!-- ui-dialog -->
	<div id="dialog-close" title="关闭原因">
		<table width="90%" border="0" cellspacing="5" cellpadding="5"
			style="margin-left:20px;">
			<tr>
				<td height="80%">
					<textarea  rows="" cols="" style="width: 350px;;height:130px;;overflow: auto;" id="addCloseReason">
