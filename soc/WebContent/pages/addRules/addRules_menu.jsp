		...
		<table width="99%" border="0" cellspacing="5px" cellpadding="0px"
			...
			<tr>
				<td align="left"><a href="#" class="common_node"
					onclick="parent.mainFrame.location.href='${ctx}/pages/addRules/addRules.jsp';">
						&nbsp; <img src="${ctx}/images/arrow_03.gif" />&nbsp;<span style="vertical-align:top">添加解析规则</span></a></td>
			</tr>
