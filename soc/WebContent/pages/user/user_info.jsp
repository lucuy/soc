...
<script language="javascript">
	jQuery(document).ready(function() {
		...
		initRadio1('assetsSelect','ids-assetGroup');
	});
	function assetDlg() {
									...
									<table width="99%" border="0" align="center" cellspacing="0"
										...
										<tr id="tr_password_1">
											...
											<td width="50%" align="left" style="padding-left:8px"><input
												type="savedSecret" name="user.userSavedSecret" id="savedSecret"
												size="30" value="${ user.userSavedSecret}" readonly="readOnly" disabled="disabled" style="width:70%" maxlength="22" autocomplete="off"/>
												</td>
											<td align="left"></td>
										</tr>
										<tr></tr>
										<tr><td align="right"></td><td width="50%" align="left" style="padding-left:8px"><input type="button" value="生成动态码" disabled="true"></td></tr>
										...
										<tr id="tr_password_1">
											...
											<td width="50%" align="left" style="padding-left:8px"><input
												...
												size="30" class="validate[minSize[6],maxSize[22]]"
											...
											<td width="40%" style="padding-left:10px" align="left"><select
												style="width: 100%;" name='roles'>
													...
													<c:if test="${roleId != 33 }">	<option value='${roleId}'
															<c:if test="${roleId eq userroleid }"> selected="selected"</c:if>>
															${roleName}</option>
														...
														<td><select name="assetsSelect" id="assetsSelect"
															style="width: 275px" size="5" multiple="multiple">
																...
																<s:iterator value="assetGroupList" status="stat">
																	<option value="${assetGroupId}" id="assetGroup">
																		${assetGroupName}</option>
																</s:iterator>
									...
									<table width="99%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td width="60%" style="padding-left:8px" align="left"><input
												name="user.userEmail" type="text" size="30"
												value="${user.userEmail}" id="useremail"
										...
										<tr>
											...
											<td style="padding-left:8px" align="left"><input
												name="user.userMobile" type="text" size="30"
												value="${user.userMobile}" id="userMobile"
										...
										<tr>
											...
											<td style="padding-left:8px" align="left"><input
												...
												id="usertelephone" value="${user.userTelephone}"
												maxlength="255" style="width:67%" />
											</td>
										</tr>
										<!-- 空行 -->
