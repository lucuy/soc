...
(function($, undefined){
    $.widget("ui.portlet", {
        ...
        _createSinglePortlet: function(portlet, _ele, column, positon, pattrs) {
            ...
            // event element
            title.prepend("<a  class='ui-corner-all ui-portlet-event'><span class='ui-icon ui-icon-refresh ui-portlet-refresh'></span></a>");
            title.prepend("<a class='ui-corner-all ui-portlet-event'><span class='ui-icon ui-icon-minusthick ui-portlet-toggle'></span></a>");
            // content
            var ct = $('<div/>', {
            ...
            $(_ele).find('.ui-portlet-header').dblclick(function() {
                ...
                if($item.hasClass('ui-portlet-single-view')) {
                    ...
                    $item.removeClass('ui-portlet-single-view').animate({
                        ...
                        height: $item.data('height') // important
                    }).css({
                        position: 'static'
