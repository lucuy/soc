...
$("#picture3").val(chart3.getSVG());
$("#picture4").val(chart4.getSVG());
	$("#export").submit();
...
exporting:{ 
        ...
        chart3 = new Highcharts.Chart({
            chart: {
                renderTo: 'container3',//要显示在div的id
                plotBackgroundColor: null,
                plotBorderWidth: null,
                plotShadow: false
            },
...
exporting:{ 
        ...
        chart4 = new Highcharts.Chart({
            chart: {
                renderTo: 'container4',//要显示在div的id
                plotBackgroundColor: null,
                plotBorderWidth: null,
                plotShadow: false
            },
...
exporting:{ 
  ...
  <body bgcolor=#ffffff leftmargin=10 topmargin=15 marginwidth=8
	...
	<form action="ExportReport.action" name="export1" method="post" id = "export" >
			...
			<input type="hidden"  name="picture3" id="picture3"></input>
			<input type="hidden"  name="picture4" id="picture4"></input>
			
			</div>

			<div style="">	
			<input type="hidden"  name="reportType" id="reportType" value = ""/> 
			<input type="hidden"  name="picCount" id="picCount" value = "4"/> 
		...
		<table  border=0 cellpadding=0 cellspacing=0 style = "width:100%;">
			<tr>
				<td colspan=7 style = "text-align:left"><font size=+2>告警统计周报</font></td>
											...
											<tr>
												...
												<td colspan="2">
													<table width=60% border=1 cellpadding=0 cellspacing=0 style = "margin-left:auto;margin-right:auto;">
																...
																<tr height=15>
																	<td width=40%><b>告警类型</b></td>
																	<td width=40%><b>告警数量</b></td>
...
<#list report12Table1?sort_by("count")?reverse as table1>	
								...
								<td colspan="2">
<div id="container1" width = "680"></div>
								</td>
...
<#list report12Table2?sort_by("count")?reverse as table1>	
								...
								<td colspan="2">
<div id="container2" width = "680"></div>
								</td>
...
<#list report12Table3?sort_by("count")?reverse as table1>	
								...
								<td colspan="2">
<div id="container3" width = "680"></div>
								</td>
...
<#list report12Table4?sort_by("count")?reverse as table1>	
								...
								<td colspan="2">
<div id="container4" width = "680"></div>
								</td>
